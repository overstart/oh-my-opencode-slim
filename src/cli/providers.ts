...
export const MODEL_MAPPINGS = {
  ...
  free: {
    orchestrator: { model: 'opencode/mimo-v2-pro-free' },
    oracle: { model: 'opencode/qwen3.6-plus-free', variant: 'high' },
    librarian: { model: 'opencode/nemotron-3-super-free', variant: 'low' },
    explorer: { model: 'opencode/big-pickle', variant: 'low' },
    designer: { model: 'opencode/mimo-v2-pro-free', variant: 'medium' },
    fixer: { model: 'opencode/minimax-m2.5-free', variant: 'low' },
  },
  volcengine: {
    orchestrator: { model: 'volcengine-plan/glm-5.2' },
    oracle: { model: 'volcengine-plan/glm-5.2', variant: 'high' },
    council: { model: 'volcengine-plan/glm-5.2', variant: 'medium' },
